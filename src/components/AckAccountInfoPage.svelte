                ...
                {#if changes.configError}
                  <li>
                    ...
                    {:else if configError === 'NO_CONNECTION_TO_DEBTOR'}
                      ...
                      изпращате или получавате пари по тази сметка, но
                      ще можете да я използвате като опорна валута.
                    ...
                    {#if debtorData.peg}
                      {#if action.previousPeg}
                        {#if !changes.pegParams}
                          Издателят е променил дигиталната монета на
                          обявената от него опорна валута. При
                          необходимост по-късно ще можете да
                          потвърдите тази промяна.
                        {:else}
                      ...
                      {/if}
                    {:else}
                      Обявеният преди фиксиран курс е премахнат.
                    {/if}
                  </li>
                {/if}
