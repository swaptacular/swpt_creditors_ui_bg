...
export const INVALID_SCANNED_COIN = (
  ...
  + "за правилната дигитална монета."
)
...
export const COIN_FETCH_ERROR = (
  ...
  + "информация за валутата от дигиталната монета. Това може да е "
...
export const PEG_DISPLAY_MISMATCH = (
  ...
  + "за базовата валута. Първо се уверете, че сте потвърдили последните "
  + "промени в базовата валута. След това можете да опитате да одобрите "
