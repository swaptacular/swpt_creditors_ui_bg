...
export const SUMMARY_TRANSLATIONS: { [key: string]: string } = {
  [usdSummary]: (
    ...
    "Щатският долар (символ: $; код на валутата: USD; също съкращаван като US$,"
      + " за да се различава от другите валути, наречени „долар“; наричан още долар,"
      + " американски долар или разговорно бакс) е официалната валута на"
      + " Съединените американски щати и на няколко други държави."
  ),
  [eurSummary]: (
    // The translated summary for EUR:
    "Еврото (символ: €; код на валутата: EUR) е официалната валута на много"
      + " от държавите членки на Европейския съюз. Тази група държави е официално"
      + " известна като „еврозоната“. Валутата се използва официално и от"
